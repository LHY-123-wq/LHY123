...
def load_data():
    # 加载数字化转型指数数据
    df = pd.read_excel(r'c:\Users\13541\Desktop\LHY\1999-2023数值化转型指数数据汇总表.xlsx')
    
    # 加载行业代码数据
    industry_df = pd.read_excel(r'c:\Users\13541\Desktop\LHY\最终数据dta格式-上市公司年度行业代码至2021.xlsx')
